...
(function (global, factory) {
    ...
    function throttled(fn, thisArg, updateFn) {
        const updateArgs =
            updateFn || ((args) => Array.prototype.slice.call(args));
        let ticking = false;
        let args = [];
    ...
    class PluginService {
        ...
        _notify(descriptors, chart, hook, args) {
            ...
            for (const descriptor of descriptors) {
                ...
                if (
                    callback(method, params, plugin) === false &&
                    args.cancelable
                ) {
                    return false;
                }
    ...
    function generateTicks$1(generationOptions, dataRange) {
        ...
        if (
            ...
            if (
                almostEquals(numSpaces, Math.round(numSpaces), spacing / 1000)
            ) {
