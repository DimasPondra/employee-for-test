!(function (t) {
     ...
     */ !(function () {
        ...
        ["pie", "doughnut", "polarArea", "bar"].forEach(function (e) {
            t[e] = !0;
        }),
            ...
            (e.prototype.renderToDataset = function (t, e) {
            ...
            (e.prototype.renderToElement = function (t, e, o, n) {
                if (!this.shouldRenderToElement(e.meta, o)) return;
                this.percentage = null;
                const i = this.getLabel(t, o, n);
                if (!i) return;
                const s = this.ctx;
                s.save(),
                    (s.font = Chart.helpers.fontString(
                        this.options.fontSize,
                        this.options.fontStyle,
                        this.options.fontFamily
                    ));
                const r = this.getRenderInfo(o, i);
                this.drawable(o, i, r)
                    ? (s.beginPath(),
                      (s.fillStyle = this.getFontColor(t, o, n)),
                      this.renderLabel(i, r),
                      s.restore())
                    : s.restore();
            }),
            (e.prototype.renderLabel = function (t, e) {
                return this.options.arc
                    ? this.renderArcLabel(t, e)
                    : this.renderBaseLabel(t, e);
            }),
            (e.prototype.renderBaseLabel = function (t, e) {
                const o = this.ctx;
                if ("object" == typeof t)
                    o.drawImage(
                        t,
            ...
            (e.prototype.renderArcLabel = function (t, e) {
                const o = this.ctx,
                    n = e.radius,
                    i = e.view;
            ...
            (e.prototype.shouldRenderToElement = function (t, e) {
                return (
                    !t.hidden &&
            ...
            (e.prototype.getLabel = function (t, e, o) {
                let n;
            ...
            (e.prototype.getFontColor = function (t, e, o) {
            ...
            (e.prototype.getPercentage = function (t, e, o) {
            ...
            (e.prototype.getRenderInfo = function (t, e) {
            ...
            (e.prototype.getBaseRenderInfo = function (t, e) {
                if (
            ...
            (e.prototype.getArcRenderInfo = function (t, e) {
                let o;
                const n = t;
                o =
                    "outside" === this.options.position
            ...
            (e.prototype.getBarRenderInfo = function (t, e) {
            ...
            (e.prototype.drawable = function (t, e, o) {
            ...
            (e.prototype.outsideInRange = function (t, e, o, n) {
            ...
            (e.prototype.measureLabel = function (t) {
                if ("object" == typeof t)
            ...
            Chart.register({
                id: "labels",
                beforeDatasetsUpdate: function (o, n, i) {
                    if (!t[o.config.type]) return;
                    Array.isArray(i) || (i = [i]);
                    const s = i.length;
                    (o._labels && s === o._labels.length) ||
                        (o._labels = i.map(function () {
                            return new e();
                        }));
                    let r = !1,
                        a = 0;
                    for (let t = 0; t < s; ++t) {
                        const e = o._labels[t];
                        if (
                            (e.setup(o, i[t]), "outside" === e.options.position)
                        ) {
                            r = !0;
                            const t =
                                1.5 * e.options.fontSize +
                                e.options.outsidePadding;
                            t > a && (a = t);
                        }
                    }
                    r && ((o.chartArea.top += a), (o.chartArea.bottom -= a));
                },
                afterDatasetUpdate: function (e, o) {
                    t[e.config.type] &&
                        e._labels.forEach(function (t) {
                            t.args[o.index] = o;
                        });
                },
