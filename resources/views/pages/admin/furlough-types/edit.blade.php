...
@section('title', 'Edit Furlough Type')
...
@section('content')
    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                <h2 class="content-title mb-4">Edit Furlough Type</h2>
            </div>
            ...
            <div class="col-12 statistics-card">
                <form action="{{ route('admin.furlough-types.update', $furloughType) }}" method="POST">
                    @method('PATCH')
                    @csrf
